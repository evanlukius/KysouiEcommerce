...
class AdminController extends Controller
{
    ...
    public function add_coupon_store(Request $request)
    {
        ...
        $coupon->save();
        return redirect()->route("admin.coupons")->with('status','Coupun has been added successfully !');
    }
    ...
    public function update_coupon(Request $request)
    {
        ...
        $coupon->expiry_date = $request->expiry_date;               
        $coupon->save();           
        return redirect()->route('admin.coupons')->with('status','Coupun has been updated successfully !');
    }
    ...
    public function delete_coupon($id)
    {
            $coupon = Coupon::find($id);        
            $coupon->delete();
            return redirect()->route('admin.coupons')->with('status','Coupun has been deleted successfully !');
    }
}
